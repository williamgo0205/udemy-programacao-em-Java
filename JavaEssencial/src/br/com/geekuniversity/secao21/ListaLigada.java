...
public class ListaLigada {
	...
	public void adiciona(Object elemento) {
		if (this.total == 0) {
			...
			nova.setAnterior(this.ultima); // <- Objeto -> Seta o anterior
			this.ultima = nova;
			this.total = this.total + 1;
		}
	}
	...
	/**
	 * Método que pega a posição do elemento repassado
	 * 
	 * @param posicao
	 * @return
	 */
	...
	/**
	 * Método que retorna o tamanho da lista ligada
	 * 
	 * @return
	 */
	public int tamanho() {
	...
	/**
	 * Método que verifica se o valor repassado contem na lista
	 * 
	 * @param obj
	 * @return
	 */
