...
public class Programa82 {
	...
	public static void main(String[] args) {
		...
		Month mes = anoNovo.getMonth(); // Devolve o mês
		int dia = anoNovo.getDayOfMonth(); // Devolve o primeiro dia do mês

		System.out.println("O ano novo será em: " + dia + " de " + mes + " de " + ano);

		// Quantos dias faltam da data atual até o ano novo?
		...
		// Formatando data e Hora padrão Brasileiro
		...
		// Colocando um hrário de intervalo
