...
public class Programa80 {
	...
	public static void main(String[] args) {
		...
		// Como copiar o conteúdo do Stream para outra lista de curso;
		List<Curso> resultado = cursos.stream()
									.filter(c -> c.getAlunos() >= 100)
									.collect(Collectors.toList()); // coleta as informações e insere em uma nova lista
		System.out.println();
		System.out.println(">>>> Cursos filtrados pelo Collect do Stream");
		resultado.forEach(System.out::println);
		
		System.out.println();
		System.out.println(">>>> Utilização do Collectors.toMap");
		cursos.stream()
		    .filter(c -> c.getAlunos() >= 100)
