...
public class Programa78 {
	...
	public static void main(String[] args) {
		...
		int soma = 	cursos.stream()
					    ...
					    .mapToInt(Curso::getAlunos) // Mapeia para inte e permite que possamos efetuar cálculs com o resultado
					    .sum(); // Sum -> Soma os valores porém não permite expressão lambda
